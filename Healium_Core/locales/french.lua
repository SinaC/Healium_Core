...
if H.client == "frFR" then
	...
	L.CHECKSPELL_NOSPELLSFOUND = "Aucun sort configur\195\169 pour cette liste de sorts"
	L.CHECKSPELL_NOTYETLEARNED = "Le sort %s(%d) n'est pas encore connu"
	L.CHECKSPELL_INVALIDSPEC = "Le sort %s(%d) n'est pas accessible dans cette sp\195\169cialisation"
	L.CHECKSPELL_NOTAVAILABLE = "Le talent %s(%d) n'est pas encore accessible"
	L.CHECKSPELL_NOTSELECTED = "Le talent %s(%d) n'a pas \195\169t\195\169 choisi"
