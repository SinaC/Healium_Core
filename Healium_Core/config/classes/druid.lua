...
C["DRUID"] = {
	predefined = {
		 ...
		 [5] = { spellID = 18562, buffs = { 774, 8936, 155777 } }, -- Swiftmend, castable only if affected by Rejuvenation or Regrowth or Rejuvenation (Germination)
		 ...
		 [13] = { spellID = 102693 }, -- Force of nature
	},
 }
